...
if __name__ == '__main__':
    dataset_path = '/media/File4/zhouyang/bcnn2/data/h5/';
    model_path = '/media/File4/zhouyang/bcnn2/VGG16/';
    ...
    for i in range(0,50):
        train_data_file.append('/media/File4/zhouyang/bcnn2/data/h5/train/' + 'train' + str(i) + '.h5');
        val_data_file.append('/media/File4/zhouyang/bcnn2/data/h5/val/' + 'val' + str(i) + '.h5');
    num_class = 120;
    train_batch_size = 8;
    val_batch_size = 8;
    ...
    target = tf.placeholder("float", [None, 120])

    resvgg = resvgg(imgs,0.5,'/media/File4/zhouyang/bcnn2/VGG16/vgg16_weights.npz', sess, finetune = False)    # fine tuning
    ...
    optimizer = tf.train.MomentumOptimizer(learning_rate=0.2, momentum=0.5).minimize(loss)  # for fine tuning
    ...
    # resvgg.load_own_weight(sess , '/media/File4/zhouyang/bcnn2/VGG16/vgg16_weights.npz');   # load the model trained before 
